        ...
        <>
             <div className='group bg-white  shadow-md overflow-hidden rounded-md relative cursor-pointer h-fit duration-1000 '>
                       <div className="relative group overflow-hidden  ">
                        ...
                        <div className='mt-2'>
                            <Link  href={`/productDetails/${item._id}`} className='px-3 py-3 flex items-center justify-center text-[#fff] bg-[#111]  hover:bg-blue-600 hover:text-[#111] w-full'>Book Now</Link>
                        </div>
                    </div> 
        </>
    );
